      ...
      <div className="event-list-detailed">
        {events.map(({
          ...
          <div className="row-event-detailed" key={_id}>
            <time
              className="col-time-detailed icon uppercase"
            ...
            <div className="col-details-detailed">
              <p className="row-title-detailed bold-title uppercase">{title}</p>
              <p className="row-description-detailed capitalize">{description}</p>
              <i className="tiny material-icons">access_time</i>{' '}
              {dayjs(time.slice(0, time.length - 7)).format('HH:mm A')}
